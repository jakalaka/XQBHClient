                    ...
                    while (true) {
                        try {
                            ...
                            if ("pause".equals(xmlMapIn.get("FUNCTION"))) {//暂定营业
                                ...
                                pw.write(sXmlOut);
                                pw.flush();
                            } else if ("updClientStock".equals(xmlMapIn.get("FUNCTION"))) {//获取model信息
                                String position = "";
                                ...
                                if (xmlMapIn.get("checkPass") != null && "1".equals(xmlMapIn.get("checkPass"))) {
                                    //出货并启轮询进程
                                    Order.Init();
                                    ...
                                    Task<Void> thingsOutTask = new Task<Void>() {
                                        ...
                                        public Void call() throws Exception {
                                            if (!ThingOut.exec() || Order.outFail) {
                                                ...
                                                if (UpdateDSPXX.exec(xmlMapIn.get("position").toString(), Integer.parseInt(xmlMapIn.get("goodsAccount").toString()))) {
                                                    xmlMapOut.put("CWDM_U", "AAAAAA");
                                                } else
                                                    xmlMapOut.put("CWDM_U", "FFFFFF");
                                            }
